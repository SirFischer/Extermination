...
#include "GrateItem.hpp"


GrateItem::GrateItem(Yuna::Core::ResourceManager *pResourceManager)
{
	mTexturePath = "assets/textures/grate.png";
...
void	GrateItem::Render(Yuna::Core::Window *pWindow)
{
